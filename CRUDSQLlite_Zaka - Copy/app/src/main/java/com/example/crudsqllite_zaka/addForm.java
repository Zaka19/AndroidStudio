...
public class addForm extends AppCompatActivity {
    ...
    public void accept(){
        ...
        if(tv.getText().toString().isEmpty()){
            Toast.makeText(this, "Has de poner una descripcion.", Toast.LENGTH_SHORT).show();
            return;
        }
        else {
        ...
        if(TryCatchDouble(tv.getText().toString().replaceAll(",","."))) {
            ...
            Toast.makeText(this, "Has de poner un numero.", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(TryCatchInt(tv.getText().toString().replaceAll(",","."))) {
            ...
            Toast.makeText(this, "Has de poner un numero entero.", Toast.LENGTH_SHORT).show();
            return;
        }

        if(pvp < 0){
            Log.d("numero",String.valueOf(stock));
            Toast.makeText(this, "Has de poner un numero superior o igual a 0.", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(idTask == -1) {
            ...
            if(tv.getText().toString().isEmpty()) {
                ...
                return;
                    ...
                    Toast.makeText(this, "El codigo ya esta en la base de datos.", Toast.LENGTH_SHORT).show();
                    return;
                }
            else if(stock < 0){
                Toast.makeText(this, "Has de poner un numero superior a 0.", Toast.LENGTH_SHORT).show();
                return;
            }
            else{
